export const createGoldenCards = () => {
  const goldenCards = [
    ...
    { id: 'reward-32', type: '보상', content: '우리 전 조한테 5코인 기부하기', effect: '코인 -5' },
    ...
    { id: 'reward-49', type: '보상', content: '릴레이 그림 퀴즈 하고 인증하면 5코인 획득', effect: '코인 +5' },
    { id: 'reward-50', type: '보상', content: '릴레이 그림 퀴즈 하고 인증하면 5코인 획득', effect: '코인 +5' },
    { id: 'reward-51', type: '보상', content: '릴레이 그림 퀴즈 하고 인증하면 5코인 획득', effect: '코인 +5' },
